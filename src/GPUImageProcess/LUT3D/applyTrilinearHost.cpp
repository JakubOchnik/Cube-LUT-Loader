...
cv::Mat GpuTrilinear::applyTrilinearGpu(const DataLoader& loader, const float opacity, const int threads)
{
	...
	// Process data
	GpuTrilinearDevice::run(threadsGrid, blocksGrid, imgPtr, 3, lutPtr, loader.getCube().LUT3D.dimension(0), opacity,
